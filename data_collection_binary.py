...
#testing data
count = len(os.listdir("E://test_data_2.0//Gray_imgs//A"))
...
cv2.imwrite("E:\\SLR-minor\\white.jpg",white)
...
while True:
    try:
        ...
        if hands:
            ...
            x, y, w, h = hand['bbox']
            image = frame[y - offset:y + h + offset, x - offset:x + w + offset]
            white = cv2.imread("E:\\SLR-minor\\white.jpg")
            # img_final=img_final1=img_final2=0
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            flag = False
            # #training data
            # count = len(os.listdir("E://sign2text_dataset_2.0/Binary_imgs//" + p_dir + "//"))

            # test data
            count = len(os.listdir("E://test_data_2.0/Gray_imgs//" + p_dir + "//"))
        ...
        if flag==True:
            ...
            if suv==50:
                flag=False
            if step%2==0:
                cv2.imwrite("E:\\test_data_2.0\\Gray_imgs\\" + p_dir + "\\" + c_dir + str(count) + ".jpg",
                            img_final1)
                cv2.imwrite(
                    "E:\\test_data_2.0\\Gray_imgs_with_drawing\\" + p_dir + "\\" + c_dir + str(count) + ".jpg",
                    img_final2)
